...
During this thesis, Google Gemini was used for finding literature (checked afterwards) and sharpening ideas for the RAG pipeline. It was also used to convert bullet points into text for some sections of the thesis.

Claude Sonnet 4.6 was used for code generation, prompting it with the intended architecture and content of the code, and the model implementing and documenting.
