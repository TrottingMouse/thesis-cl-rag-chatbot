...
An important attribute of RAG pipelines which cannot be captured by the previous four metrics is negative rejection. This is the ability to reject questions which cannot be answered with the given context. In order to measure negative rejection, a second dataset was created only containing this kind of questions.
