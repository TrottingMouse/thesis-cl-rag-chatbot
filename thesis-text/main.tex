...
\begin{itemize}
    \item
\end{itemize}
% Beispiele: eins (je) warum für character besser als dynamictoken;
% evaluation funktioniert für beste 2
% was macht maxmin richtig
...
\begin{longtable}{
    ...
    % --- First Page Header ---
    \caption{Evaluation of Question Answering Responses} \label{tab:qa_evaluation_all}                                                                                                                                                                                                                                                                                                                                                                                                                                               \\
    \toprule
    ...
    \caption[]{(Fortsetzung) Evaluation of Question Answering Responses}                                                                                                                                                                                                                                                                                                                                                                                                                                                             \\
    \toprule
    \textbf{\#}                                                                                                                                                                                                                                                                                                                                                                                                                              & \textbf{Query} & \textbf{Response} & \textbf{Reference Answer} & \textbf{Correctness} \\
    \midrule
    \endhead
