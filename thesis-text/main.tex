...
Here is the drafted subsubsection, structured logically to fit seamlessly into your thesis:
...
For LLM chunking, a customized chunker for the documents could be built. This chunker should be based on sentences instead of paragraphs, as paragraphs are to coarse-grained here.\\
...
\begin{itemize}
    ...
    \item in-sentence/word separation caused less problems than for previous research
    \item
\end{itemize}
