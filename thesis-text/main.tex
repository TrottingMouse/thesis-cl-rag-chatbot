...
Thus, three separate experiments are done to optimize document preprocessing, query expansion and chunking hyperparameters before the main experiment, which is comparing preprocessor/chunker pairs.
